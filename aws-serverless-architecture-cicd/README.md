...
graph LR
    ...
    Users((Users)) --> CloudFront --> S3
    Users --> APIGW --> Lambda --> DynamoDB
    CodePipeline --> SAM
    SAM --> Lambda
    SAM --> APIGW
    SAM --> DynamoDB
...
### API code is available [here](https://github.com/SagarDevExpo/DevOps-Projects/tree/master/DevOps-Project-22/serverless-api)

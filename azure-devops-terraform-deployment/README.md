...
```mermaid
graph LR
    subgraph AzDevOps["Azure DevOps"]
        Repo[Git Repo]
    ...
    Repo --> Pipeline --> TFPlan --> TFApply
    TFApply --> RG --> Resources
    TFPlan --> State
    TFApply --> State
```
...
> *If you'd like to skip straight to the download of the example pipeline and Terraform code, it can be found on* [*GitHub*](https://github.com/SagarDevExpo/DevOps-Projects/tree/master/DevOps-Project-20/terraform)*.*

...
graph TB
    ...
    TF -->|provisions| EKS
    Jenkins --> Docker --> Registry --> EKS
    EKS --> ChatUI
    ChatUI --> OpenAI
    Users((Users)) --> Svc --> ChatUI
```
...
**GITHUB REPO**: [Chatbot-UI](https://github.com/SagarDevExpo/DevOps-Projects/tree/master/DevOps-Project-28/Chatbot-UI)

```
git clone https://github.com/SagarDevExpo/DevOps-Projects/DevOps-Project-28/Chatbot-UI
...
pipeline{
    ...
    stages {
        stage('Checkout from Git'){
            steps{
                git branch: 'master', url: 'https://github.com/SagarDevExpo/DevOps-Project-28/Chatbot-UI.git'
            }
        }

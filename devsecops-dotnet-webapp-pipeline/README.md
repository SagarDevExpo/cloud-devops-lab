...
[![DevOps-Project-24: DotNet Monitoring](https://img.shields.io/badge/Project-DotNet%20Monitoring-brightgreen)](https://github.com/SagarDevExpo/DevOps-Projects/tree/master/DevOps-Project-24/DotNet-monitoring)
...
graph TB
    ...
    Git --> Build --> SAST --> Docker --> Scan --> Registry
    Registry --> K8s --> App
...
pipeline {
    ...
    stages {
        ...
        stage('Checkout From Git') {
            steps {
                git branch: 'master', url: 'https://github.com/SagarDevExpo/DevOps-Projects/tree/master/DevOps-Project-24/DotNet-monitoring'
            }
        }
...
stage("Docker Build & tag"){
        ...
        stage("TRIVY"){
            steps{
                sh "trivy image SagarDevExpo/dotnet-monitoring:latest > trivy.txt" 
            }
        }
        stage("Docker Push"){
            steps{
...
stage("Deploy to container"){
            steps{
                sh "docker run -d --name dotnet -p 5000:5000 SagarDevExpo/dotnet-monitoring:latest"
            } 
        }
```

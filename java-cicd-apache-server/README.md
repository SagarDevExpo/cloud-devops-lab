...
graph LR
    ...
    subgraph CD["Continuous Deployment"]
        ...
        Apache[Apache Tomcat Server]
    end
    Git --> Jenkins --> Maven --> WAR --> Deploy --> Apache
    Users((Users)) --> Apache
```
...
```go
git clone https://github.com/SagarDevExpo/DevOps-Projects/tree/master/DevOps-Project-32/JavaApp-CICD.git
```

...
graph TB
    ...
    Git --> Jenkins --> SonarQube --> OWASP --> Docker --> Trivy
    Trivy --> K8s
    Users((Users)) --> Ingress --> FE --> BE --> DB
```
...
## **Source Code:** : [HERE](https://github.com/SagarDevExpo/DevOps-Projects/tree/master/DevOps-Project-33/DevSecOps-CI-CD-Pipeline)
